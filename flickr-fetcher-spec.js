...
describe('FlickrFetcher', function() {
  ...
  describe('#transformPhotoObk()', function() {
    it('should take a photo object and return with just title and URL', function() {
      var input = {
                id:       '25373736106',
                owner:    '99117316@N03',
                secret:   '146731fcb7',
  ...
  describe('#fetchPhotos()', function() {
    it('should take and API key and fetcher function, and return a promise for transformed photos', function() {
