...
describe('#photoToListItem()', function() {
  it('should take a photo and return a list item string', function() {
    var input = {
...
describe('#photoToListHTML()', function() {
...
describe('#addPhotostoElement()', function() {
  it('should take an HTML string of list items and add them to an element with a given sleector', function() {
